...
def _row_payload(r: pd.Series) -> dict:
    return {
        ...
        "rotation_group": r.get("rotation_group"),
        ...
        "pair_type": r.get("pair_type") or None,
        "pair_signal": r.get("pair_signal") or None,
...
def build_ai_input(
    ...
    focus_tickers.update(pairs["ticker"].tolist())

    # Limit AI context while preserving decision-useful securities.
    focus_tickers = set(list(sorted(focus_tickers))[:90])
